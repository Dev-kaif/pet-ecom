...
const Blog = () => {
  ...
  return (
    <section className="relative py-20 lg:py-24 xl:py-30 overflow-hidden bg-white px-32">
      ...
      <div className="container mx-auto px-4 custom-container">
        ...
        <div className="flex items-center justify-between mb-16 lg:mb-20">
          <div className="text-left">
            <span className="text-secondary text-lg font-bold uppercase tracking-wider block mb-2">
              NEWS & BLOGS
            </span>
            <h2 className="text-4xl lg:text-5xl font-extrabold leading-tight text-primary">
              Our Recent Articles
            </h2>
          </div>
          <Link
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 justify-items-center">
          {blogPosts.map((post, index) => (
            <motion.div
              key={index}
              className=" px-5 py-3 bg-white border border-gray-200 rounded-3xl overflow-hidden shadow-sm hover:shadow-lg transition-all duration-300 relative"
            ...
            >
              ...
              <div className="blog__content p-6 space-y-4">
                <div className="blog__meta flex items-center text-sm text-gray-600 mb-2">
                ...
                {/* Title */}
                <h4 className="title text-xl font-bold text-primary leading-tight group-hover:text-secondary transition-colors duration-300">
